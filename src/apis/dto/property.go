...
type CreatePropertyRequest struct {
	...
	Icon        string `json:"icon" binding:"required,max=1000"`
	CategoryId  int    `json:"category_id" binding:"required"`
	Description string `json:"description" binding:"required,min=15,max=1000"`
...
type UpdatePropertyRequest struct {
	...
	Description string `json:"description,omitempty" binding:"min=15,max=1000"`
...
type GetPropertyResponse struct {
	...
	Category    GetPropertyCategoryResponse `json:"category"`
...
type GetPropertyCategoryResponse struct {
	...
	Name       string                `json:"name"`
	Icon       string                `json:"icon" `
	Properties []GetPropertyResponse `json:"properties"`
}
